...
void Map::loadLevel(int level)
{
	...
	std::string map1[4] = { "ASSETS/Maps/map1_Tile Layer 1.csv" , "ASSETS/Maps/map1_Tile Layer 2.csv","ASSETS/Maps/tiled_example_Col Layer.csv","ASSETS/Maps/tiled_example_Item Layer.csv"};
